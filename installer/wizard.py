...
def main():
    ...
    with dpg.theme(tag="installer_theme"):
        with dpg.style():
            dpg.add_style_color(dpg.mvThemeCol_WindowBg, (25, 25, 35))
            dpg.add_style_color(dpg.mvThemeCol_Text, (220, 220, 230))
            dpg.add_style_color(dpg.mvThemeCol_Button, (70, 110, 190))
            dpg.add_style_color(dpg.mvThemeCol_FrameBg, (40, 40, 55))
            dpg.add_style_color(dpg.mvThemeCol_TitleBar, (30, 30, 50))
